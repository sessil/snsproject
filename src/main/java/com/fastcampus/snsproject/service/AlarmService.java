...
public class AlarmService {
    ...
    public void send(AlarmType alarmType, AlarmArgs args, Integer receiveUserId) {
        ...
        UserEntity user = userEntityRepository.findById(receiveUserId).orElseThrow(() -> new SnsApplicationException(ErrorCode.USER_NOT_FOUNED));
        //alarm save
        AlarmEntity alarmEntity = alarmEntityRepository.save(AlarmEntity.of(user, alarmType, args));
