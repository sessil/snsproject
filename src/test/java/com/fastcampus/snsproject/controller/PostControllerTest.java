...
public class PostControllerTest {
    ...
    @Test
    @WithMockUser
    void 포스트수정시_본인이작성한_글이아니라면_에러발생() throws Exception{
    ...
    @Test
    @WithAnonymousUser
    void 좋아요기능시_로그인하지_않은경우() throws Exception{
        //mocking : TODO
        //when(postService.my(any(),any())).thenReturn(Page.empty());
    ...
    @Test
    @WithMockUser
    void 좋아요클릭시_개시물이없는_경우() throws Exception{
        //mocking : TODO
    ...
    @Test
    @WithAnonymousUser
    void 댓글기능시_로그인하지_않은경우() throws Exception{
        //mocking : TODO
        mockMvc.perform(post("/api/v1/posts/1/comments")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsBytes(new PostCommentRequest("comment")))
    ...
    @Test
    @WithMockUser
    void 댓글작성시_개시물이없는_경우() throws Exception{
        //mocking : TODO
