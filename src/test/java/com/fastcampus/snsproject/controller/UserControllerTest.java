...
public class UserControllerTest {
    ...
    public void 회원가입() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/users/join")
                ...
                // to do : add Request Body
                .content(objectMapper.writeValueAsBytes(new UserJoinRequest(userName, password)))
        ).andDo(print())
                .andExpect(status().isOk());
    }
    @Test
    public void 회원가입시_이미_회원가입을_하는경우_에러반환() throws Exception  {
        String userName = "userName";
        String password = "password";
    ...
    public void 로그인() throws Exception {
        ...
        // TODO : mocking
        when(userService.login(userName, password)).thenReturn("Test Tocken");
    ...
    public void 로그인시_회원가입이_안된_userName을_입력할경우_에러반환() throws Exception {
        ...
        // TODO : mocking
        when(userService.login(userName, password )).thenThrow(new SnsApplicationException(ErrorCode.USER_NOT_FOUNED));
